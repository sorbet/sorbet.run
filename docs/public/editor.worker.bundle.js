...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__position_js__ = __webpack_require__(10);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lifecycle_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__winjs_base_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__async_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__platform_js__ = __webpack_require__(14);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
function logOnceWebWorkerWarning(err) {
    if (!__WEBPACK_IMPORTED_MODULE_4__platform_js__["f" /* isWeb */]) {
        // running tests
        return;
    }
...
var SimpleWorkerProtocol = /** @class */ (function () {
    ...
    SimpleWorkerProtocol.prototype.sendMessage = function (method, args) {
        ...
        var result = new __WEBPACK_IMPORTED_MODULE_2__winjs_base_js__["b" /* TPromise */](function (c, e) {
            reply.c = c;
            reply.e = e;
        }, function () {
    ...
    SimpleWorkerProtocol.prototype._handleMessage = function (msg) {
        ...
        result.then(function (r) {
            ...
            if (e.detail instanceof Error) {
                ...
                e.detail = Object(__WEBPACK_IMPORTED_MODULE_0__errors_js__["g" /* transformErrorForSerialization */])(e.detail);
            }
            _this._send({
                vsWorker: _this._workerId,
                seq: req,
                res: undefined,
                err: Object(__WEBPACK_IMPORTED_MODULE_0__errors_js__["g" /* transformErrorForSerialization */])(e)
            });
        });
    };
...
var SimpleWorkerClient = /** @class */ (function (_super) {
    ...
    function SimpleWorkerClient(workerFactory, moduleId) {
        ...
        _this._lazyProxy = new __WEBPACK_IMPORTED_MODULE_2__winjs_base_js__["b" /* TPromise */](function (c, e) {
            lazyProxyFulfill = c;
            lazyProxyReject = e;
        }, function () { });
    ...
    SimpleWorkerClient.prototype.getProxyObject = function () {
        ...
        return new __WEBPACK_IMPORTED_MODULE_3__async_js__["d" /* ShallowCancelThenPromise */](this._lazyProxy);
    };
    SimpleWorkerClient.prototype._request = function (method, args) {
        var _this = this;
        return new __WEBPACK_IMPORTED_MODULE_2__winjs_base_js__["b" /* TPromise */](function (c, e) {
...
var SimpleWorkerServer = /** @class */ (function () {
    ...
    SimpleWorkerServer.prototype.initialize = function (workerId, moduleId, loaderConfig) {
        ...
        var cc;
        var ee;
        var r = new __WEBPACK_IMPORTED_MODULE_2__winjs_base_js__["b" /* TPromise */](function (c, e) {
            cc = c;
            ee = e;
        });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__errors_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__winjs_base_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cancellation_js__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__lifecycle_js__ = __webpack_require__(0);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
function createCancelablePromise(callback) {
    var source = new __WEBPACK_IMPORTED_MODULE_2__cancellation_js__["b" /* CancellationTokenSource */]();
...
function wireCancellationToken(token, promise, resolveAsUndefinedWhenCancelled) {
    ...
    if (resolveAsUndefinedWhenCancelled) {
        promise = promise.then(undefined, function (err) {
            if (!__WEBPACK_IMPORTED_MODULE_0__errors_js__["d" /* isPromiseCanceledError */](err)) {
        ...
        return new __WEBPACK_IMPORTED_MODULE_1__winjs_base_js__["b" /* TPromise */](function (c, e, p) {
            winjsPromiseOrThenable.done(function (result) {
                try {
                    ...
                    __WEBPACK_IMPORTED_MODULE_0__errors_js__["e" /* onUnexpectedError */](e1);
                }
                c(result);
            }, function (err) {
                try {
...
function first(promiseFactories, shouldStop, defaultValue) {
    ...
    var loop = function () {
        if (index >= len) {
            return __WEBPACK_IMPORTED_MODULE_1__winjs_base_js__["b" /* TPromise */].as(defaultValue);
        }
        var factory = promiseFactories[index++];
        var promise = factory();
        return promise.then(function (result) {
...
/* unused harmony export create */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__base_common_uri_js__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__base_common_winjs_base_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_range_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__diff_diffComputer_js__ = __webpack_require__(134);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__base_common_diff_diff_js__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__core_position_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__model_mirrorTextModel_js__ = __webpack_require__(136);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__modes_linkComputer_js__ = __webpack_require__(137);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__modes_supports_inplaceReplaceSupport_js__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__model_wordHelper_js__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__standalone_standaloneBase_js__ = __webpack_require__(97);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__base_common_platform_js__ = __webpack_require__(14);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
var MirrorModel = /** @class */ (function (_super) {
    ...
    MirrorModel.prototype.getWordAtPosition = function (position, wordDefinition) {
        var wordAtText = Object(__WEBPACK_IMPORTED_MODULE_9__model_wordHelper_js__["d" /* getWordAtText */])(position.column, Object(__WEBPACK_IMPORTED_MODULE_9__model_wordHelper_js__["c" /* ensureValidWordDefinition */])(wordDefinition), this._lines[position.lineNumber - 1], 0);
        if (wordAtText) {
...
var BaseEditorSimpleWorker = /** @class */ (function () {
    ...
    BaseEditorSimpleWorker.prototype.loadForeignModule = function (moduleId, createData) {
        ...
        // ESM-comment-end
        // ESM-uncomment-begin
        return __WEBPACK_IMPORTED_MODULE_1__base_common_winjs_base_js__["b" /* TPromise */].wrapError(new Error("Unexpected usage"));
        // ESM-uncomment-end
    };
...
if (typeof importScripts === 'function') {
    ...
    __WEBPACK_IMPORTED_MODULE_11__base_common_platform_js__["b" /* globals */].monaco = Object(__WEBPACK_IMPORTED_MODULE_10__standalone_standaloneBase_js__["a" /* createMonacoBaseAPI */])();
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__base_common_diff_diff_js__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__base_common_strings_js__ = __webpack_require__(3);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
var LineMarkerSequence = /** @class */ (function () {
    ...
    LineMarkerSequence._getFirstNonBlankColumn = function (txt, defaultValue) {
        var r = __WEBPACK_IMPORTED_MODULE_1__base_common_strings_js__["firstNonWhitespaceIndex"](txt);
        if (r === -1) {
            return defaultValue;
        }
        return r + 1;
    ...
    LineMarkerSequence._getLastNonBlankColumn = function (txt, defaultValue) {
        var r = __WEBPACK_IMPORTED_MODULE_1__base_common_strings_js__["lastNonWhitespaceIndex"](txt);
        if (r === -1) {
            return defaultValue;
        }
        return r + 2;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__viewModel_prefixSumComputer_js__ = __webpack_require__(91);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_position_js__ = __webpack_require__(10);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__core_characterClassifier_js__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_uint_js__ = __webpack_require__(54);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(86), __webpack_require__(85)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__range_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__position_js__ = __webpack_require__(10);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__linkedList_js__ = __webpack_require__(98);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__common_services_editorSimpleWorker_js__ = __webpack_require__(133);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__base_common_worker_simpleWorker_js__ = __webpack_require__(109);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
function initialize(foreignModule) {
    ...
    var simpleWorker = new __WEBPACK_IMPORTED_MODULE_1__base_common_worker_simpleWorker_js__["b" /* SimpleWorkerServer */](function (msg) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__uint_js__ = __webpack_require__(54);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
var CharacterClassifier = /** @class */ (function () {
    function CharacterClassifier(_defaultValue) {
        var defaultValue = Object(__WEBPACK_IMPORTED_MODULE_0__uint_js__["d" /* toUint8 */])(_defaultValue);
    ...
    CharacterClassifier.prototype.set = function (charCode, _value) {
        var value = Object(__WEBPACK_IMPORTED_MODULE_0__uint_js__["d" /* toUint8 */])(_value);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__winjs_base_js__ = __webpack_require__(9);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__diffChange_js__ = __webpack_require__(135);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__core_uint_js__ = __webpack_require__(54);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__base_common_event_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__base_common_keyCodes_js__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_position_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__core_range_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__core_selection_js__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__base_common_winjs_base_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__base_common_cancellation_js__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__core_token_js__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__base_common_uri_js__ = __webpack_require__(25);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
function createMonacoBaseAPI() {
    return {
        editor: undefined,
        languages: undefined,
        CancellationTokenSource: __WEBPACK_IMPORTED_MODULE_6__base_common_cancellation_js__["b" /* CancellationTokenSource */],
